...
public class HooksDemoTest extends Basepage{
	...
	public void setAPIEndpointURL() {
		config=readProperties("src//test//java//com//factory//cucumber//configuration/Config.properties");
		String apiHostName = config.getProperty("BaseURL");
